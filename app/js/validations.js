    ...
    rules: {
        ...
        c_last_name: {
            required: function(element) {
                        return ($("#type").val()=="Legal Entity" || $("#type").val()=="");
                    },
            lettersonly: true
        },
        owner_type: {
...
$('#form_huf').submit(function() {
    ...
    removeMultiInputNamingRules('#form_huf', 'input[alt="family_member_name[]"]');
...
$('#form_purchase').submit(function() {
    removeMultiInputNamingRules('#form_purchase', 'input[alt="owner_contact_name[]"]');
...
function checkOwnership() {
    ...
    $('.ownership').each(function() {
        ...
        for(i=parseInt(index)+1; i<=counter; i++) {
            if ($('#owner_name_'+i+'_id').val()==owner_name_id) {
                var errors = {};
...
$('#form_sale').submit(function() {
    removeMultiInputNamingRules('#form_sale', 'input[alt="owner_contact_name[]"]');
...
$("#form_rent").validate({
    ...
    invalidHandler: function(e,validator) {
        ...
        if ($('#panel-rent-details').find("input.error, select.error").length>0) {
            errors=errors+"Please Clear errors in rent details. <br/>";
        }
...
$('#form_loan').submit(function() {
    removeMultiInputNamingRules('#form_loan', 'input[alt="borrower_name[]"]');
    removeMultiInputNamingRules('#form_loan', '.doc_name');

    addMultiInputNamingRules('#form_loan', 'input[name="borrower_name[]"]', { required: function(element) {
                                                                                                if($("#submitVal").val()=="0"){
                                                                                                    return true;
                                                                                                } else {
                                                                                                    return false;
...
function checkBorrower() {
    ...
    $('.ownership').each(function() {
        ...
        for(i=parseInt(index)+1; i<=counter; i++) {
            if ($('#borrower_'+i+'_id').val()==borrower_name_id) {
                var errors = {};
