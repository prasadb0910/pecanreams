    ...
    <div id="repeat_doc_<?php echo $doc_no; ?>" class="form-group" style="background:none; border:none;">
        ...
        <div class="col-md-2">
            <div class="col-md-6" >
                ...
                <input type="file" class="fileinput btn btn-success padding-height doc_file" name="doc_<?php echo $doc_no; ?>" id="doc_file_<?php echo $doc_no; ?>" data-error="#doc_<?php echo $doc_no; ?>_error"/>
