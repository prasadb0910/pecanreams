...
<div class="service-overlay"></div>
		...
		<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse"> 
			 	<ul id="menu-primary" class="nav navbar-nav navbar-right">
						...
						<ul class="dropdown-menu" >
						  <li><a href="about.html#company">About Us</a></li>    <li class="divider"></li>
						  <li><a href="about.html#about">Our Ventures</a></li>
					   <li class="divider"></li>
						  <li><a href="about.html#portfolio">Our Team</a></li>
  ...
  <section id="company" class="section" style="position:relative;padding-top:20px; overflow:hidden; padding:0 0 100px; background:#eee;">
...
Covering an average of 150 notices on a daily basis.
		...
		<div class="col-md-3 col-sm-6" style="margin-top: 80px;">
            <div class="serviceBox" >
                <div class="service-icon "style=" background:#eee" >
                    <img src="assets/images/assure_new.png" class="img-responsive img-rounded" alt="" style="padding:30px">
                </div>
                <div class="service-content" style="margin-top: 40px;">
                    
                    <p>
                     Timely notifications enabling the client to be abreast about public notices concerning their Immovable properties
                    </p>
                </div>
...
<ul class="feature">
								...
								<li id="feature_2"  class="feature_11">       									
									<div class="col-sm-12 col-md-12 feature-box clearfix">	
										...
										<div class="feature-box-content">
											...
											<p>Topmost form on making an public announcement of intention to undertake a transaction, pre-requisite to establish a legal claim on a property, checking for liabilities on a property etc.</p>
										</div>
									</div>
								</li>
								
								<li id="feature_3"  class="feature_11">       									
									<div class="col-sm-12 col-md-12 feature-box clearfix">	
										<div class="feature-box-icon">
										...
										<div class="feature-box-content">
											...
											<p>On missing of public notice by the concerned person, the counter-party could take a stand in court of law that they had made a valid public notice issuance.</p>
										</div>
									</div>
								</li>
...
<p> Online depository of public notices.
 ...
 <div id="classroom" class=" " style=" background:#eee">
										<h2 style="text-align: center;color:#282828;font-weight:400">Current & Prospective Stakeholders</h2>
...
<ul class="clients">
	  	<li> Important to track public notices on the properties owned by them.</li>
	  <li> This will ensure that they don't miss any untoward incident regarding the properties they own.</li>
...
<ul class="clients">
	  	...
	  	<li>It is important to track and be in know how on anything happening w.r.t property (transaction,title notice,litigation notice etc.).</li><br>
...
<ul class="clients">
	  	...
	  	<li>Typically, it is a time consuming,tedious and under paid task when compared to the effort and time involved	.</li> <br>
</ul>
