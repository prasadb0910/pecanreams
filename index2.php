			...
			<div class="collapse navbar-collapse" id="navbar-collapse"> 
			 	<ul id="menu-primary" class="nav navbar-nav navbar-right">
						...
						<ul class="dropdown-menu" >
						  <li><a href="about.html#company">About Company</a></li>    <li class="divider"></li>
						  <li><a href="about.html#about">Our Groups</a></li>
					   <li class="divider"></li>
...
<div class="container" style="margin-top:40px;margin-bottom:20px">
    <div class="row">
        <div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon" >
                    <img src="assets/images/main_logo2.png" class="img-responsive img-rounded" alt="" style="padding:30px;margin:0 auto">
                </div>
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon">
                   <h1><b style="font-family:'seguibl' !important;font-size:32px;text-align:center;color: rgb(40, 55, 122);">iDATA</b></h1>
                </div>
                <div class="service-content">
