...
<div class="service-overlay"> </div>
        ...
        <span class="caret"></span></a>
          ...
          <li><a href="<?php echo $base_url; ?>app/" target="_blank">REAMS</a></li><li class="divider"></li>
          <li><a href="<?php echo $base_url; ?>d3m/" target="_blank">iDATA</a></li>
    ...
    <div class="row" style="text-align:center;">
        <div class="col-md-12 col-sm-12  ">
            ...
            <div><img src="assets/images/reams1.jpg" class="img-responsive img-rounded" alt=""></div>
			   ...
			   <div class="col-md-6 col-sm-6  ">
            <p align="left">One stop solution to manage transactions, cash flows, documents and tasks. Helps reducing errors & saves costs.</p><p align="left">Complete Real Estate Asset Management, by team of professionals, taking care of on-boarding transactions, daily activities and on field assistance. </p>
			<br>
			<br>
			
			
		
              <a href="reams_features.html" class="" style="align:center; top:20px" ><span class="btn btn-default  btn-read  btn-width  ">   Read More..  </span></a>
            </div>
      ...
      <div class="col-md-12 col-sm-12  ">
			...
			<a href="idata_register.php"  style="align:center; margin-bottom:20px;" ><span class="btn btn-default  btn-read  btn-width  ">   Read More..  </span></a>
