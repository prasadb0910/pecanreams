...
if(isset($_POST["submit"])) {
    ...
    // $check=mysqli_query($conn2,"select * from group_users where gu_email='$email' or gu_mobile='$mobile'");
    $check=mysqli_query($conn2,"select * from group_users where gu_email='$email'");
    if($check){
    ...
    if($checkrows>0) {
        ...
        if($package==''){
            ...
            $sql = "insert into group_master (group_name, group_status, create_date, created_by, modified_date, modified_by, display_group_name) 
                    values ('".$main_group_name."', 'Active', '".$now."', '0', '".$now."', '0', '".$display_group_name."')";
            ...
            $sql = "insert into contact_master (c_name, c_last_name, c_gid, c_emailid1, c_mobile1, c_status, c_createdate, c_createdby, c_modifieddate, c_modifiedby) 
                    values ('".$name."', '".$last_name."', '".$group_id."', '".$email."', '".$mobile."', 'Approved', '".$now."', '0', '".$now."', '0')";
            mysqli_query($conn, $sql);
            ...
            $sql = "insert into group_users (gu_gid,name,gu_email,gu_mobile,gu_password,gu_role,add_date,gu_cid,assigned_status,assigned_role,created_at,created_by,updated_at,updated_by,user_type,isVerified) 
                    values ('".$group_id."','".$name."','".$email."','".$mobile."','".$password."','Admin','".$now."','".$contact_id."','Approved','1','".$now."','0','".$now."','0','owner','0') ";
            if (mysqli_query($conn, $sql)) {
                ...
                header("Location: dataFrom.htm?user_id=".$user_id."&sub_id=".$package."&trans_id=0");
            } else {
...
<body class="single single-post postid-3434 single-format-image nav-sticky" style="background:#d4d4d4">
    ...
    <form id="rf" class="form-signin" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" style="<?php if(isset($_SESSION["otp"])) echo 'display: none;'; ?>" autocomplete="off">       
        ...
        <div class="input-group"  style="margin-bottom:5px" >
            ...
            <input type="text" class="form-control" name="first_name" placeholder="First Name" value="<?php if(isset($_POST["first_name"])) echo $_POST["first_name"]; ?>" required autofocus />
        </div>
        <div class="input-group"  style="margin-bottom:5px" >
            <span class="input-group-addon"><i class="fa fa-user"></i></span>
            <input type="text" class="form-control" name="last_name" placeholder="Last Name" value="<?php if(isset($_POST["last_name"])) echo $_POST["last_name"]; ?>" required/>
        </div>
        <div class="input-group"  style="margin-bottom:5px" >
            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
            <input type="text" class="form-control"  name="email" placeholder="Email" value="<?php if(isset($_POST["email"])) echo $_POST["email"]; ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required/>
        </div>
        <div class="input-group" style="margin-bottom:5px" >
            <span class="input-group-addon" ><i class="fa fa-lock" ></i></span>
            <input id="password" type="text" name="password" class="form-control" placeholder="Password" value="<?php if(isset($_POST["password"])) echo $_POST["password"]; ?>" pattern=".{8,}" title="Six or more characters" required/>
        </div>
        <div class="input-group"  style="margin-bottom:5px" >
        ...
        <div class="input-group"  style="margin-bottom:5px" >
            ...
            <input type="text" class="form-control" name="main_group_name" placeholder="Group Name" value="<?php if(isset($_POST["main_group_name"])) echo $_POST["main_group_name"]; ?>" required/>
        </div>
        <!-- <div class="input-group"  style="margin-bottom:5px" >
            <span class="input-group-addon"><i class="fa fa-users"></i></span>
    ...
    <form id="rf" class="form-signin" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" style="<?php if(!isset($_SESSION["otp"])) echo 'display: none;'; ?>">       
        <div style="font-size:24px; text-align:center" ><b>Enter OTP </b><?php //echo $_SESSION["otp"]; ?></div>
        ...
        <br>
        <input style="margin-top:0px" type="submit" id="verify" name="verify" class="btn btn-lg btn-primary btn-block" value="Verify"/>
    </form>
            ...
            <div class="row">
                <div class="col-lg-4  col-md-4 col-sm-3 col-xs-12">
                    <div class="housing-line">
                        <div class="footer-logo-coloured"> <a href="index.html"><img src="assets/images/main-logo.png" style="background:#fff; padding:5px 10px;" /> </a></div>
                        <!---<div class="desc">
                ...
                <div class="col-lg-4  col-md-4 col-sm-5 col-xs-4">
                    ...
                    <ul class="list-unstyled clear-margins col-md-6 col-sm-6 col-xs-12">
                        <li><a  href="about.html"> About Us</a></li>
                        <li><a  href="about.html"> Our Team</a></li>
                        <li><a  href="index.php#contact-map"> Contact Us</a></li>
                    </ul>
