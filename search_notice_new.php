...
<?php
    ...
    $notice_type_id = '0';
    $notice_type = 'All';
	$meta_title = 'Find Public Notice Online India – Search Public Legal Notices | Pecan Reams';
	$notice_title = 'Find Public Notice Online India – Search Public Legal Notices | Pecan Reams';
	$heading = 'Find Legal & Public Notices Online';
	$notice_description = 'Browse all types of public notices & legal notices online in India. More than 42 newspapers public notices data available. You can set up the public notice alert which will notify you by email and SMS. ';
...
<head>
	...
	<meta name="Description" content="<?php if ($meta_description <> ''){echo $meta_description;} else {echo $notice_description; }?>">
	...
	<![endif]-->
		<title> <?php if ($meta_title <> ''){echo $meta_title;} else {echo  'Pecan Reams - '.$notice_title; }?></title>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-9318749488518989",
...
<body class="single single-post postid-3434 single-format-image nav-sticky">
	...
	<div class="navbar navbar-fixed-top floating positive two" role="navigation">
		...
		<span class="caret"></span></a>
		<ul class="dropdown-menu">
		<li><a href="https://www.pecanreams.com/rent_mgmt/" target="_blank">REAMS</a></li><li class="divider"></li>
				...
				<div class="col-md-12">
					<header>
						<h2 id="share-title" style="color:#fff;"> Search Notices </h2>
					 	<p class="info breadcrumbs" style="font-size:12px;"><span class="breadcrumbs_list" > <a href="<?php echo $base_url; ?>/index.php">Home ></a><a href="#"> Search Notices </a>  </span></p>
					 </header>
				</div>
			</div>
		</div>
	...
	<section id="" class="section offsetTop offsetBottom" style="padding-top: 0px;">
		...
		<div class="row">
		<div class="col-md-3 notices" id="notices_list">
			<h2 style="text-align: left; color: #696f6f; margin-bottom:15px; font-size:25px;">Notice Type</h2>
	
					<ul class="rectangle-list">
					 <li><a href="<?php echo $base_url.'/search-notice-new/All'?>">All Notices</a></li>
					<?php 
							...
							while ($row = mysqli_fetch_assoc($result)) 
							{?>
				  <li><a class=""   href="<?php echo $base_url.'/search-notice-new/'.$row["url"]; ?>"><?php echo $row["notice_type"]; ?></a></li><?php } ?>
					</ul>
		</div>
		<div class="col-md-12"  id="notice_type_div" style="display:none;margin-top:20px">
		
		
		
					<div class="dropdown" >
						<a class="btn btn-primary dropdown-toggle" href="#" data-toggle="dropdown" style="width:100%">Select  Notice Type
						<span class="caret"></span></a>
						<ul class="dropdown-menu">
						<?php 
				...
				<div class="col-md-9">
			<h2 style="text-align: center; color: #696f6f; margin-bottom:15px; font-weight: bold; font-size:25px;"> <?php if ($heading <> ''){echo $heading;} else {echo $notice_type; }?> </h2>
			<div id="prodo-contact-form" class="field-action">
				<form id="form_search" action="<?php echo $base_url.'/search-notice-new/'.$notice_type_url; ?>" method="post">
					<div class="contact-form-area">
						...
						<div class="row">
							<div class="g-recaptcha" data-sitekey="6LdkqVMUAAAAAAE3gA6N51u5u6pKFL93yivmRuLt" style="margin-left: 30px;"></div>
							<div id="g_recaptcha_response" style="color:red; margin-left: 30px;"></div>
						</div>
						<div class="row">
	...
	<script type="text/javascript" charset="utf8" src='<?php echo $base_url; ?>/js/jquery-1.11.1.min.js'></script>
