...
<link rel='stylesheet' id='responsive-css'  href='assets/css/responsive.min.css?ver=4.6.1' type='text/css' media='all' />
 ...
 <link rel='stylesheet'   href='css/blogs1.css' type='text/css' media='all' />
		...
		<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse"> 
				...
				<!--	<li class="dropdown">
					...
					<li ><a class="jumper" href="#map">Contact Us</a></li>
...
<div class="text-center">
				<div class="row">
					<div class="col-md-12">
				 	...
				 	<h1 class="animate"> Access to in-depth knowledge & market insights about the Real estate projects registered under the Real Estate Regulation Act (MAHARERA). </h1>
...
<div class="text-center">
				<div class="row">
					<div class="col-md-12">
				 	...
				 	<h1 class="animate"> Timely notifications enabling the client to be abreast about public notices concerning their Immovable properties.</h1>
...
<div class="text-center">
				<div class="row">
					<div class="col-md-12">
				 	...
				 	<h1 class="animate"> Advisory services for Fund Raising, Joint Ventures, Mergers & Acquisitions. </h1>
    ...
    <div class="row" style="text-align:center;">
        <div class="col-md-3 col-sm-3  ">
           ...
           <h2>REAMS </h2>
            ...
            <div><img src="assets/images/reams1.jpg" class="img-responsive img-rounded" alt=""></div>
			 
            </div>
           <p align="left">One stop solution to manage transactions, cash flows, documents and tasks. Helps reducing errors & saves costs.Complete Real Estate Asset Management, by team of professionals, taking care of on-boarding transactions, daily activities and on field assistance. </p>
      ...
      <div class="col-md-3 col-sm-3  ">
           ...
           <div class="frame-container" style="">
            <div><img src="assets/images/idata44.jpg" class="img-responsive img-rounded" alt=""></div>
           
            </div>
			
			<p align="left">iData is our online analytics tool providing data and real estate research covering the under-construction Real estate projects in Maharshtra. By leveraging our database, our users gain access to information that would otherwise take months to assemble, along with the tools to search, analyze, compare, chart, and audit at a click of a button.</p>
            </div>
           </div>
           ...
           <div class="frame-container" style="">
			...
			<p align="left">Online repository of Public Notices, Convenient place for storing and retrieving announcements, Notifies client regarding any public notice issued on his/her asset through alerts,Timely alerts through email & SMS helps client to take well informed decisions</p>
            </div>
           </div>
...
<li> Efficient and cost effective.&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  </li>
                ...
                <div class="read">
                    <a href="reams_features.php">read more...</a>
                </div>
            </div>
        </div>
...
<li> Tech-enabled real estate platform which provides comprehensive analytical tools. </li>
<li> Aids informed decision making.</li>
<li> Provides market insights.</li>
                ...
                <div class="read">
                    <a href="idata_register.php">read more...</a>
                </div>
            </div>
        </div>
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon">
                    <img src="assets/images/assure_new.png" class="img-responsive img-rounded" alt="" style="padding:30px;margin: 0 auto;">
                </div>
                <div class="service-content">
...
<li> Enables the clients to take appropriate legal action in crucial limited time.&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp   </li>
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon">
                    <img src="assets/images/pecan-logo.png" class="img-responsive img-rounded" alt="" style="padding:30px">
                </div>
                <div class="service-content">
...
<li> Rich experience across industries in Corporate Finance, Fund Raising, Mergers & Acquisitions. </li>
...
<div class="col-md-8">
	<h2 style="text-align: center;color:#282828;font-weight:400">Blogs</h2>
<div class="col-md-6 col-sm-6 animated bounceInLeft">
	<div class="single-about-detail clearfix">
		...
		<div class="about-details" style="background:#fff;box-shadow: 0 1px 1px rgba(0,0,0,.3);">
		 	<small class="cat">category</small> 
		 <a href="easy-buy-difficult-sell.html"> 
		
		 <h3 class="blog1" style="text-align:left">Daily Real Estate News Digest </h3> </a>
<p>
	  	Square Yards, the tech-backed transaction & aggregation platform for global real estate, is looking to expand ..

	 
</p>
 <small class="name">Name</small><br>
 <small class="date"><i class="fa fa-calendar-o"></i> Nov 12,2015</small>
	...
	<div class="single-about-detail clearfix">
		...
		<div class="about-details" style="background:#fff;box-shadow: 0 1px 1px rgba(0,0,0,.3);">
		<small class="cat">category</small> 
		 <a  href="does-investing-in-far-off-places-make-sense.html">  <h3 class="blog1" style="text-align:left">Daily Real Estate News Digest
</h3> </a>
<p>
	  	Huda has issued notices to around 3,000 plot-holders across Gurgaon to recover dues amounting to around Rs.500cr..</p>
...
<small class="name">Name</small><br>
 <small class="date"><i class="fa fa-calendar-o"></i> Nov 12,2015</small>
	    ...
	    <div class="col-md-12 text-center"><a class="btn btn-default">Read More</a></div>    
					  
</div>    
<div class="col-md-4">
	<h2 style="text-align: center;color:#282828;font-weight:400">Newsletters</h2>
<div class="col-md-12 col-sm-12 animated bounceInLeft news">
	<div class="single-about-detail clearfix">
		
		<div class="about-details">
	
<div class="news_1" style="padding-top:10px;padding-bottom:35px;">
<div class="newsletters">
	<time datetime="2014-09-20" class="icon">

  <strong>Sept</strong>
  <span>20</span>
</time><span class="para"><p>
Daily Real Estate News Digest
</p></span>
</div>
...
<div id="bodyContent">
<p style="line-height:24px; font-weight:400;">  210, 2nd Floor, Sanjay Mittal Ind. Premises, <br> Mittal Industrial Estate, Bldg. No- 2B, <br> Andheri Kurla Road, Andheri – East,<br> Mumbai- 400059 , tel - 022 6143 1777<br>Email - info@pecanreams.com</p>
</div>
</div>
