		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					<select class="form-control select2" id="developer" multiple="multiple" data-placeholder="Select a Developer" style="width: 100%;">
...
<script type="text/javascript">
    mixpanel.track("Developer Level Page.");
</script>
@endsection