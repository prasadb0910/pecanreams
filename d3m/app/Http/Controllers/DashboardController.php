...
class DashboardController extends Controller
{
    ...
    public function reams() {
        $url =  '/../../app/index.php/login/get_laravel_session/';
        return $this->set_session($url);
    }

    public function get_user_profile() {
        $url =  '/../../app/index.php/login/get_user_profile/';
        return $this->set_session($url);
    }

    public function get_user() {
        $url =  '/../../app/index.php/login/get_user/';
        return $this->set_session($url);
    }

    public function get_user_roles() {
        $url =  '/../../app/index.php/login/get_user_roles/';
        return $this->set_session($url);
    }
    ...
    public function index() {  
        ...
        if(session('module')=='idata'){
            ...
            } else if(isset($access['AdminDashboard'])) {
