...
Route::get('/reams', 'DashboardController@reams')->name('dashboard.reams');
Route::get('/assure', 'DashboardController@assure')->name('dashboard.assure');
Route::get('/idata', 'DashboardController@idata')->name('dashboard.idata');
Route::get('/get_user_profile', 'DashboardController@get_user_profile')->name('dashboard.get_user_profile');
Route::get('/get_user', 'DashboardController@get_user')->name('dashboard.get_user');
Route::get('/get_user_roles', 'DashboardController@get_user_roles')->name('dashboard.get_user_roles');

Route::get('/home', 'HomeController@index')->name('home.index');

Route::get('/login/get_ci_session/{id}', 'Auth\LoginController@get_ci_session')->name('login.get_ci_session');
Route::get('/login/set_assure_session/{id}', 'Auth\LoginController@set_assure_session')->name('login.set_assure_session');
Route::get('/login/set_idata_session/{id}', 'Auth\LoginController@set_idata_session')->name('login.set_idata_session');
...
Route::post('/dashboard/get_data', 'DashboardController@get_data')->name('dashboard.get_data');
