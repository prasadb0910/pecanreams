...
if(isset($_POST["submit"])) {
    ...
    if($checkrows>0) {
        ...
        //     $sql = "insert into group_users(name,gu_email,gu_mobile,gu_password,assigned_role,isVerified)values('".$name."','".$email."','".$mobile."','".$password."','2','0') ";
...
<body class="single single-post postid-3434 single-format-image nav-sticky" style="background:#d4d4d4">
    ...
    <form id="form_registration" class="form-signin" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" style="<?php if(isset($_SESSION["otp"])) echo 'display: none;'; ?>">       
        ...
        <div class="input-group" style="margin-bottom:5px" >
            ...
            <input id="password" type="password" name="password" class="form-control" placeholder="Password" value="<?php if(isset($_POST["password"])) echo $_POST["password"]; ?>" pattern=".{8,}" title="Six or more characters" autocomplete="off" required onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : ''); if(this.checkValidity()) form.confirm_password.pattern = RegExp.escape(this.value);"/>
        </div>
        <div class="input-group" style="margin-bottom:5px" >
            <span class="input-group-addon" style="padding: 6px 16px;"><i class="fa fa-lock" ></i></span>
    ...
    <form id="form_otp" class="form-signin" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" style="margin-bottom: 0px; padding-bottom: 0px; <?php if(!isset($_SESSION["otp"])) echo 'display: none;'; ?>">       
        <div style="font-size:24px; text-align:center" ><b>Enter OTP</b></div>
        <?php if (isset($_POST["verify"]) ){print $msg;}?>
        <?php if (isset($_POST["resend"]) ){echo $msg;}?>
        <!-- <br>
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
            <input type="text" class="form-control" name="otp" placeholder="OTP" pattern="[0-9]{6}" required/>
        </div>
        <br>
