...
<div class="text-center">
				<div class="row">
					<div class="col-md-12">
				 	<h1 class="animate"> Make basic data on Developers, Projects, Market easy to get and use. </h1>
...
<div class="container">
<h2 style="text-align: center;">About iDATA</h2>


<p>iData is our online analytics tool providing data and real estate research covering the under-construction Real estate projects in Maharshtra. By leveraging our database, our users gain access to information that would otherwise take months to assemble, along with the tools to search, analyze, compare, chart, and audit at a click of a button.</p><p> Our online database captures over 9000+ projects of nearly 5000+ developers and generates analysis for all verticals under the residential, commercial and retail sectors from a macro to a micro level. Essential Analytics tools to strengthen market knowledge, allow for detailed property comparisons and provide self consulting insights.</p>
...
<div class="back">
<p>Help real estate professions get insights on the demand supply situation in various micro-markets and developer groups. </p>
</div>
...
<div class="back">
<p> Providing analytics, data and real estate research covering the Real estate Industry in Maharshtra.</p>
</div>
</div>
...
<div class="back">
<p>Increase profitability by making accurate data driven decision.</p>
</div>
</div>
...
<br>
 <div id="classroom" class=" " style=" ">
					<h2 style="text-align: center;">Current Audience</h2>
	...
	<div class="single-about-detail clearfix">
		...
		<div class="about-details">
		 <a  href="does-investing-in-far-off-places-make-sense.html">  <h3>Real Estate Developers
	  	...
	  	<p>Sitting on land parcel in Mumbai and wanting to know what other developers are up to? How about viewing all the publicly available details of all the Projects around you? iData empowers you to view all the projects including their stages of development, pricing and specification at the mere click of a button.
	...
	<div class="single-about-detail clearfix">
	   ...
	   <img   src="assets/images/Picture3.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=" "  > 
		...
		<div class="about-details">
	  	...
	  	<p>A business deal is hard to find, Isn’t it? Well how about we make it easy for you! With access to all the registered projects in the state, you can sift through and make an informed decision, thus cutting out the middle man and ensuring a smoother process of Lending to the Project/Builder of your choice.&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
