		...
		<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse"> 
			 	<ul id="menu-primary" class="nav navbar-nav navbar-right">
						...
						<li ><a class="jumper" href="#">Home</a></li>
...
<div class="container" style="margin-top:40px;margin-bottom:20px">
    <div class="row">
        <div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon">
                    <img src="assets/images/main_logo1.png" class="img-responsive img-rounded" alt="" style="padding:30px;">
                </div>
                ...
                <div class="read">
                    <a href="reams_features.html">read more...</a>
                </div>
            </div>
        </div>
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon">
                   <h1><b style="font-family:'seguibl' !important;font-size:x-large;text-align:center;color: rgb(40, 55, 122);">iDATA</b></h1>
                </div>
                <div class="service-content">
                    <h3>iDATA</h3>
                    <p>
                        iData is our online analytics tool providing data and real estate research covering the under-construction Real estate projects in Maharshtra. 
                    </p>
                </div>
                <div class="read">
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon">
                    <img src="assets/images/assure.png" class="img-responsive img-rounded" alt="" style="padding:30px">
                </div>
                <div class="service-content">
                    <h3>ASSURE</h3>
                    <p>
                      Notifies client regarding any public notice issued on his/her asset through alerts,Timely alerts through email & SMS helps client to take well informed decisions. 
                    </p>
                </div>
                <div class="read">
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                ...
                <div class="service-content">
                    <h3>ADVISORY</h3>
                    <p>Experience across industries in Corporate Finance, Fund Raising, Mergers & Acquisitions,Deep understanding of Real Estate.
                       </p> 
                </div>
                <div class="read">
    ...
    <div class="container">
        <div class="row">
			...
			<h2 style="text-align: center;">Blogs</h2>
				...
				<?php 
$args = array( 'numberposts' => 3, 'post_status'=>"publish",'post_type'=>"post",'orderby'=>"post_date","category__not_in" => array(5));
 ...
 foreach ($postslist as $post) :  setup_postdata($post); ?>
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            ...
                            <p class="description">
                               <?php $content = get_the_excerpt(); echo substr($content, 0, 500); ?><a href="<?php the_permalink(); ?>">Read More</a>
                            </p>
                        </div>
                    </div>
                    <?php endforeach; ?>
