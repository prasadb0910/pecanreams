...
<div class="container">
    <div class="row">
	 <div class="col-md-9 ">
	 <h2 style="text-align: center;">About Pecan Reams</h2>
     <p>Pecan Reams offers Real Estate Asset Management Solutions that empowers you to manage your real estate assets by </p>
		
	<ul>
	<li>Providing state of art technology </li>
		<ul>
	<li> Self-use software – Managed by the user.</li>
	<li>Outsourced team software - Managed by a team of professionals </li>	</ul>
	<li>Digitisation of property documents</li>
	<li>Providing Real Estate Transaction support</li>
	<li>Formulating Real Estate Strategy and valuation services.</li>
</ul>
           </div>
