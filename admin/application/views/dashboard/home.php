                                        ...
                                        <div class="form-group" style="float: left; width: 100%;">
                                            <div class="col-md-5">
                                                <div class="">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" name="email_id" placeholder="Email Address" value="<?php if(isset($contact_details)){ echo $contact_details[0]->c_emailid1; } ?>" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1"></div>
                                        ...
                                        <div class="form-group" style="float: left; width: 100%;">
                                            ...
                                            <div class="col-md-5">
                                                <div class="">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="radio" class="" name="maker_checker" value="yes" required /> Yes &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input type="radio" class="" name="maker_checker" value="no" required /> No
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
