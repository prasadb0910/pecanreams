                ...
                <div class="login-body">
                    ...
                    <form id="form_login" class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="E-mail" name="email" id="email" autofocus style="background: rgb(250, 255, 189);"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="password" class="form-control" placeholder="Password" name="password" id="password" style="background: rgb(250, 255, 189);"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <select name="module" class="form-control select" id="module" style="background: rgb(250, 255, 189);">
