            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
                     ...
                     <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/manage'; ?>" > User Role List  </a>  &nbsp; &#10095; &nbsp; User Role Details</div>	
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="main-container">  
						 <div class="box-shadow" style="padding-top:10px;">  
                            ...
                            <form id="form_user_role_details" role="form" class="form-horizontal" method="post" action="<?php if(isset($edituser)) { if($r_id==0) echo base_url().'index.php/Manage/saverecord'; else echo base_url().'index.php/Manage/updaterecord/'.$r_id;} else {echo base_url().'index.php/Manage/saverecord';} ?>">
