...
##############################PRIVATE LTD####################################
    public function add_new_pvtltd(){
        $gid=$this->session->userdata('groupid');
        $roleid=$this->session->userdata('role_id');
        $query=$this->db->query("SELECT * FROM user_role_options WHERE section = 'Owner' AND role_id='$roleid' AND r_insert = 1");
        $result=$query->result();
...
##############################PARTNERSHIP####################################
public function add_new_partnership(){
        $gid=$this->session->userdata('groupid');
        $roleid=$this->session->userdata('role_id');
        $query=$this->db->query("SELECT * FROM user_role_options WHERE section = 'Owner' AND role_id='$roleid' AND r_insert = 1");
        $result=$query->result();
...
##############################Proprietorship###########################################
    public function add_new_proprietorship(){
        $gid=$this->session->userdata('groupid');
        $roleid=$this->session->userdata('role_id');
        $query=$this->db->query("SELECT * FROM user_role_options WHERE section = 'Owner' AND role_id='$roleid' AND r_insert = 1");
        $result=$query->result();
