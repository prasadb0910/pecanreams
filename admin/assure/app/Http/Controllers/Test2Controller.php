...
class Test2Controller extends Controller
{
    ...
    public function match_criteria($criteria1, $criteria2){
        ...
        //             // echo $substr2;
        //             // echo '<br/>';
        //             // echo metaphone($substr1);
        //             // echo '<br/>';
        //             // echo metaphone($substr2);
        //             // echo '<br/>';
        //             // echo soundex($substr1);
        //             // echo '<br/>';
        //             // echo soundex($substr2);
        //             // echo '<br/>';
    ...
    public function test_no(){
        // $criteria1 = 'AAPart-';
        // $id='';
        // preg_match('/\d+/',$criteria1,$matches);
        // if(count($matches)>0) $id=$matches[0];
        // echo $id;
        // echo '<br/>';

        // $arrayName = array('0'=>'10', '1'=>'20', '2'=>'30', '3'=>'40');
        // echo array_search(10, $arrayName);
        // echo '<br/>';

        // $criteria1 = '11part, pa 45 sd, rt66*/., \\sd95*-';
        // $criteria2 = '66, 5part, pa 055 sd, rt4*/., \\sd15*-';
        ...
        // echo json_encode($check_arr1);
        // echo '<br/>';
        // echo json_encode($check_arr2);
        // echo '<br/>';

        // // foreach ($check_arr1 as $check_val) {
        // //     echo $check_val;
        // //     echo '<br/>';
        // //     $result = array_search($check_val, $check_arr2);
        // //         echo $result;
        // //         echo '<br/>';
        // //         echo 'test1';
        // //         echo '<br/>';
        ...
        $criteria1 = 'Suresh Prehar/*d89';
        $criteria2 = 'Sherjen Varugheseert8';
        ...
        $property_legal_owner_name = preg_replace('/[^A-Za-z0-9]/', '', $criteria1);
        echo $property_legal_owner_name;
        echo '<br/>';
        $property_legal_owner_name = preg_replace('/[^A-Za-z0-9 ]/', '', $criteria1);
        echo $property_legal_owner_name;
        echo '<br/>';
    ...
    public function match_property_notice($notice_id){
        ...
        // $notice = Pn_notice::where('date_of_notice','2018-03-23')->orderBy('updated_at','desc')->get();

        $sql = "select * from pn_notices where date_of_notice >= '2018-03-15' and date_of_notice <= '2018-03-31'";
        $notice = DB::select($sql);

        // $sql = "select * from pn_notices where date_of_notice <= '2018-01-31'";
        // $notice = DB::select($sql);
        ...
        foreach($notice as $data){
            ...
            // $sql = "select A.* from pn_properties A where A.status = 'approved' and A.id = '52'";
            $sql = "select A.* from pn_properties A where A.status = 'approved'";
            $property = DB::select($sql);
            foreach($property as $data1){
                ...
                $row = $row . '<tr>';
                $row = $row . '<td>'.$data->id.'</td>';
                $row = $row . '<td>'.$data1->id.'</td>';
