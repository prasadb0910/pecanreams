                ...
                <div class="form-group">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 0px; padding: 0px;">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <input type="text" class="form-control" name="apartment_no" value="@if(isset($property)){{$property->apartment_no}}@endif" placeholder="Enter Unit/Apartment No...">
                            </div>
                        </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered" id="tbl_certificate_no_detail1">
                                <thead>
                                    <tr>
                                        <th>Certificate No Type</th>
                                        <th>Certificate No</th>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered" id="tbl_purchased_from1">
                                <thead>
                                    <tr>
                                        <th>Purchased From</th>
                                        <th style="text-align:center;" class="hide">Action</th>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered" id="tbl_company_name1">
                                <thead>
                                    <tr>
                                        <th>Company Name</th>
                                        <th style="text-align:center;" class="hide">Action</th>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered" id="tbl_guarantor1">
                                <thead>
                                    <tr>
                                        <th>Guarantor</th>
                                        <th style="text-align:center;" class="hide">Action</th>
