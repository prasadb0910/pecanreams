...
<style>
    @font-face {
        ...
        src: url("{{ asset('/css/invoice/OpenSans-Regular.ttf') }}") format("truetype");
    }
...
<body style="margin: 1px;">
  ...
  <center style="width:100%;display:inline-block;margin:0 auto;">
    <img src="{{asset('/img/main-logo.png')}}" alt=""  style="vertical-align: top;margin-top: 0px;width:150px;" />
      ...
      <tr style="border-bottom:0px solid #666; padding-bottom: 0px; margin-bottom: 0px;">
        <td width="50%" rowspan="3" style="border-bottom:0px solid #666; padding-bottom: 0px; margin-bottom: 0px;">
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="2"  style="border-collapse: collapse; padding-bottom: 0px; margin-bottom: 0px;">
            <tr>
              <td>Invoice No: </td><td>{{$data['invoice_no']}}</td>
            </tr>
            <tr>
              <td>Invoice Date: </td><td>@if(isset($data['invoice_date'])){{Carbon\Carbon::parse($data['invoice_date'])->format('d/m/Y')}}@endif</td>
            </tr>
        ...
        <td width="50%" valign="top" style="line-height:12px;  border-right:1px solid #666; border-left:1px solid #666; border-bottom:1px solid #666; border-right:none; padding-bottom: 0px; margin-bottom: 0px;">
          <table width="100%"  border="0" cellspacing="0" cellpadding="2"  style="border-collapse: collapse; padding-bottom: 0px; margin-bottom: 0px;">
            <tr>
              <td width="30%">Name:</td><td>{{$data['name']}}</td>
            </tr>
            <tr>
              <td>Address: </td><td> </td>
            </tr>
...
<tr>
  ...
  <tr style="font-size:10px; font-weight:500;">
    ...
    <tr valign="top" style="border: none;">
      ...
      <td valign="top" align="left" style="border-left:1px solid #666;  border-top: none; border-bottom:none;border:none;border-right:1px solid #666;">Property Subscription - {{$data['plan_name']}}</td>
      <td width="130" valign="top" align="right" style="border-left:1px solid #666;  border-top: none; border-bottom:none;border:none;border-right:1px solid #666;"><p style="margin:0; ">{{$data['price']}}</p></td>
      <td width="130" valign="top" align="right" style="border-left:1px solid #666;  border-top: none; border-bottom:none;border:none;border-right:1px solid #666;"><p style="margin:0; ">{{$data['discount']}}</p></td>
	   <td width="130" valign="top" align="right" style="border-left:1px solid #666;  border-top: none; border-bottom:none;border:none;border-right:1px solid #666;"><p style="margin:0; ">{{$data['amount']}}</p></td>
  
     
      <td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
      <table style="width: 100%;border-spacing: 0; height: 17px;"><tr><td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%">{{$data['cgst_rate']}}</td><td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%">{{$data['cgst']}}</td></tr></table>
    </td>
     <td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
      <table style="width: 100%;border-spacing: 0; height: 17px;"><tr><td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%">{{$data['sgst_rate']}}</td><td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%">{{$data['sgst']}}</td></tr></table>
    </td>
      <td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:0px solid #666;padding:0;">
      <table style="width: 100%;border-spacing: 0; height: 17px;"><tr><td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%">{{$data['igst_rate']}}</td><td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%">{{$data['igst']}}</td></tr></table>
    </td>
      <td valign="top" align="right" style="border-left:1px solid #666; border-top: none; border-bottom:none;border:none;"><p style="margin:0; ">{{$data['total_amount']}}</p></td>
    </tr>
...
<tr>
  ...
  <tr style="border-top: 1px solid #666;">
    <td width="50%" colspan="3" rowspan="8" valign="top" style="padding:0;">
        ...
        <p style="margin:0;text-align:center;line-height:22px;font-size:18px;"><span style="  font-size:18px; font-weight:500;    margin-top: 5px;display: block;" >Amount in words: <br/><br><br><br></span>{{$data['total_amount_in_words']}}</p> 
    ...
    <td width="25%" valign="middle" style=" font-size:10px; font-weight:900;background:#ececec;">  
      ...
      <span style="text-align:right; float:right">{{$data['amount']}}</span> 
    </td>
  </tr>
  <tr>
    ...
    <td valign="middle" style=" font-size:10px; font-weight:500;" >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right">{{$data['cgst']}}</span> 
    </td>
  </tr>
  <tr>
 <td colspan="2" valign="middle" style="font-size:10px; font-weight:500;">Add: SGST</td>
    <td valign="middle" style=" font-size:10px; font-weight:500;"  >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right">{{$data['sgst']}}</span> 
    </td>
  </tr>
  <tr>
 <td colspan="2" valign="middle" style="font-size:10px; font-weight:500;">Add: IGST</td>
    <td valign="middle" style=" font-size:10px; font-weight:500;"  >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right">{{$data['igst']}}</span> 
    </td>
  </tr>
  <tr style="background:#ececec;"> 
    ...
    <td valign="middle" style=" font-size:10px; font-weight:900;" >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right">{{$data['gst']}}</span> 
    </td>
  </tr>
  <tr style="background:#ececec;"> 
    <td colspan="2" valign="middle" style="font-size:10px; font-weight:900;">
    ...
    <td valign="middle" style=" font-size:10px; font-weight:900;" >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right">{{$data['round_off_amount']}}</span> 
    </td>
  </tr>
  <tr style="background:#ececec;"> 
    <td colspan="2" valign="middle" style="font-size:10px; font-weight:900;">
    ...
    <td valign="middle" style=" font-size:10px; font-weight:900;" >  
      <span style="text-align:left; float:left"> &#8377; </span> 
      <span style="text-align:right; float:right">{{$data['value']}}</span> 
    </td>
  </tr>
  <tr> 
    <td colspan="2" valign="middle" style="font-size:10px; font-weight:900;">
