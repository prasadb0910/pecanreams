...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <span style="position:fixed; bottom:70px; left:20px; color:#fff;">
                @if (session('module')=='public_notice')
                <!-- <li class="menu--item">
                    <i class='fa fa-reply fa-1x'></i>
                    <a href="{{ url('/index.php/idata') }}" class="logo">
                       <span class="logo-lg" style="font-size: x-large;"> <b style=" font-family: 'seguibl' !important;">iDATA</b></span>
                    </a>
                </li> -->
                @else
                <li class="menu--item">
                    <i class=' fa fa-share fa-1x'></i>
                    <a href="{{ url('/index.php/public_notice') }}" class="logo">
                        <img src="{{asset('/img/assure.png')}}" alt="Assure" />
                    </a>
                </li>
                @endif
            </span>
