        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li><a href="{{ url('/index.php/home') }}">{{ Auth::user()->name }}</a></li>
                    @endif
                </ul>
            </div><!--/.nav-collapse -->
        </div>
            ...
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        ...
                        <!-- <h3><a href="{{-- url('/index.php/register') --}}" class="btn btn-lg btn-success">{{-- trans('adminlte_lang::message.gedstarted') --}}</a></h3> -->
                    </div>
                    <div class="col-lg-2">
