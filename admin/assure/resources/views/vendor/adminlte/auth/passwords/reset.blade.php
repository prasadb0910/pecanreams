...
@section('content')
    ...
    <div id="app">
        ...
        <div class="login-box-body">
            ...
            <form action="{{ url('/index.php/password/reset') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Password" name="gu_password"/>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>

                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Password" name="gu_password_confirmation"/>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
            ...
            <a href="{{ url('../../../register.php') }}" class="text-center">{{ trans('adminlte_lang::message.membreship') }}</a>
