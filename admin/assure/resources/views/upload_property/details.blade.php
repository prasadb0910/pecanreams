...
<div class="row">
    <div class="col-lg-12">
        ...
        @endif
        <form id="form_upload_property_notice" action="{{url('index.php/upload_property_notice/save')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            <div class="box">
            <div class="box-header">
                <h4 class="pull-left"><b>Property Notice Details</b></h4>
                <a href="{{url('index.php/upload_property_notice')}}" class="btn btn-primary btn-sm pull-right">Back</a>
            </div>
            <div class="box-body">
                {{csrf_field()}}
                <div class="form-group">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 0px; padding: 0px;">
                            <label class="col-md-2 col-sm-2 col-xs-12 control-label">Name of Property</label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 0px; padding: 0px;">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <input type="text" class="form-control" name="apartment_no" value="@if(isset($property)){{$property->unit_no}}@endif" placeholder="Enter Unit/Apartment No...">
                            </div>
                        </div>
                        </div>
                        <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered" id="tbl_property_no_detail1">
                                <thead>
                                    <tr>
                                        <th>Property No Type</th>
                                        <th>Property No</th>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered" id="tbl_location_detail1">
                                <thead>
                                    <tr>
                                        <th>Location Type</th>
                                        <th>Location</th>
                        ...
                        <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 0px; padding: 0px;">
                            <label class="col-md-2 col-sm-2 col-xs-12 control-label">Parking</label>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 0px; padding: 0px;">
                            <label class="col-md-2 col-sm-2 col-xs-12 control-label">Property Description</label>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 0px; padding: 0px;">
                            <label class="col-md-2 col-sm-2 col-xs-12 control-label">Issued by</label>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered" id="tbl_legal_owner_name1">
                                <thead>
                                    <tr>
                                        <th>Legal Owner Name</th>
                                        <th style="text-align:center;" class="hide">Action</th>
            ...
            @if(!Route::is('upload_property_notice.details'))
            <div class="box-footer">
                <a href="{{url('index.php/upload_property_notice')}}" class="btn btn-danger btn-sm pull-right">Cancel</a>
